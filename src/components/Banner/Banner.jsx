            ...
            <div className="container">
                <div
                    ...
                    <div className="p-6 sm:p-8 space-y-2">
                        ...
                        <h2 data-aos="zoom-out" className="uppercase text-4xl lg:text-7xl font-bold">{data.title}</h2>
                    ...
                    <div className="flex flex-col justify-center gap-4 p-6 sm:p-8">
                        <h3 data-aos="zoom-out" className="text-xl font-bold">{data.title2}</h3>
                        <h2 data-aos="fade-up" className="text-3xl sm:text-5xl font-bold">{data.title3}</h2>
